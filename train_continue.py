...
from model_improve import DM2FNet_attention_in, ours_wo_AFIM, DM2FNet_attention_chuan, DM2FNet_new2
...
def parse_args():
    ...
    parser.add_argument(
        '--exp-name',
        default='RESIDE_ITS_DM2FNet_new2_continue',
...
def main():
    ...
    net.load_state_dict(torch.load('/home/guest03/Workspace/DM2F-Net/ckpt/RESIDE_ITS_DM2FNet_new2/iter_40000_loss_0.01398_lr_0.000000.pth'))
