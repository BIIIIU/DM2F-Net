...
# DM2F-Net-improved (O-HAZE)
class DM2FNet_woPhy_new(Base_OHAZE):
    def __init__(self, num_features=64, arch='resnext101_32x8d'):
        super(DM2FNet_woPhy_new, self).__init__()
        ...
        self.fuse3_attention = ImprovedAttention_wo(num_features * 2, num_features)
        self.fuse2_attention = ImprovedAttention_wo(num_features * 2, num_features)
        self.fuse1_attention = ImprovedAttention_wo(num_features * 2, num_features)
        self.fuse0_attention = ImprovedAttention_wo(num_features * 2, num_features)
        ...
        self.attentional_fusion = ImprovedAttention_wo(num_features, 12)
...
# DM2F-Net-improved (RESIDE)
class DM2FNet_new2(Base):
    def __init__(self, num_features=128, arch='resnext101_32x8d'):
        super(DM2FNet_new2, self).__init__()
        self.num_features = num_features
...
# attention in serial
class attention_chuan(Base):
    def __init__(self, dim, dimout):
        super(attention_chuan, self).__init__()
...
class DM2FNet_attention_chuan(Base):
    def __init__(self, num_features=128, arch='resnext101_32x8d'):
        super(DM2FNet_attention_chuan, self).__init__()
        self.num_features = num_features
        ...
        # )
        self.attention_phy = attention_chuan(num_features * 4, num_features * 4)
        ...
        #     nn.Conv2d(num_features, num_features * 4, kernel_size=1)
        # )
        self.attention1 = attention_chuan(num_features * 4, num_features * 4)
        self.attention2 = attention_chuan(num_features * 4, num_features * 4)
        self.attention3 = attention_chuan(num_features * 4, num_features * 4)
        self.attention4 = attention_chuan(num_features * 4, num_features * 4)
...
#downsample version of attention in serial
class attention_chuan_down(Base):
    def __init__(self, dim, dimout):
        super(attention_chuan_down, self).__init__()

        self.norm = nn.BatchNorm2d(dim)
        # Simple Channel Attention
        self.Wv = nn.Sequential(
            nn.Conv2d(dim, dim, 1),
            nn.Conv2d(dim, dimout, kernel_size=3, padding=3 // 2, groups=dimout, padding_mode='reflect')
        )
        self.Wg = nn.Sequential(
            nn.AdaptiveAvgPool2d(1),
        ...
        # Pixel Attention
        self.pa = nn.Sequential(
            nn.Conv2d(dimout, dimout // 8, 1),
            nn.GELU(),
            nn.Conv2d(dimout // 8, 1, 1),
            nn.Sigmoid()
        )
...
class DM2FNet_woPhy_attention_chuan(Base_OHAZE):
    def __init__(self, num_features=64, arch='resnext101_32x8d'):
        super(DM2FNet_woPhy_attention_chuan, self).__init__()
        self.num_features = num_features
        ...
        #     nn.Conv2d(num_features, num_features, kernel_size=1), nn.Sigmoid()
        # )
        self.fuse0_attention = attention_chuan_down(num_features * 2, num_features)
        self.fuse1_attention = attention_chuan_down(num_features * 2, num_features)
        self.fuse2_attention = attention_chuan_down(num_features * 2, num_features)
        self.fuse3_attention = attention_chuan_down(num_features * 2, num_features)
...
class DM2FNet_woPhy_woAFIM(Base_OHAZE):
    def __init__(self, num_features=64, arch='resnext101_32x8d'):
        super(DM2FNet_woPhy_woAFIM, self).__init__()
        self.num_features = num_features
    ...
    def forward(self, x0):
        ...
        down4 = F.upsample(down4, size=down0.size()[2:], mode='bilinear')
        down3 = F.upsample(down3, size=down0.size()[2:], mode='bilinear')
        down2 = F.upsample(down2, size=down0.size()[2:], mode='bilinear')
        down1 = F.upsample(down1, size=down0.size()[2:], mode='bilinear')

        f = (down0 + down1 + down2 + down3 + down4) / 5
        f = self.refine(f) + f
...
class DM2FNet_new(Base):
    def __init__(self, num_features=128, arch='resnext101_32x8d'):
        super(DM2FNet_new, self).__init__()
        self.num_features = num_features
        ...
        self.attention_phy = ImprovedAttention(num_features * 4)
        self.attention1 = ImprovedAttention(num_features * 4)
        self.attention2 = ImprovedAttention(num_features * 4)
        self.attention3 = ImprovedAttention(num_features * 4)
        self.attention4 = ImprovedAttention(num_features * 4)
...
#attention between backbone layers, not good
class DM2FNet_attention_in(Base):
    def __init__(self, num_features=128, arch='resnext101_32x8d'):
        super(DM2FNet_attention_in, self).__init__()
        self.num_features = num_features
        ...
        self.att1 = ImprovedAttention(256)
        self.att2 = ImprovedAttention(512)
        self.att3 = ImprovedAttention(1024)
        self.att4 = ImprovedAttention(2048)
...
class DM2FNet_5att_fusion(Base):
    def __init__(self, num_features=128, arch='resnext101_32x8d'):
        super(DM2FNet_5att_fusion, self).__init__()
        self.num_features = num_features
