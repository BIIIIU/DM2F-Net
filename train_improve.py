...
from model_improve import DM2FNet_attention_in, ours_wo_AFIM, DM2FNet_attention_chuan, DM2FNet_new2, DM2FNet_woPhy_woAFIM
...
def parse_args():
    ...
    parser.add_argument(
        '--exp-name',
        default='RESIDE_ITS_DM2FNet_woPhy_woAFIM',
...
def main():
    net = DM2FNet_woPhy_woAFIM().cuda().train()
